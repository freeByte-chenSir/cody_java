package com.cody.core.deps;

import com.cody.core.config.Config;
import com.cody.core.error.CodyErrors.InteractionTimeoutError;
...
/**
 * Dependency injection container  CodyDeps dataclass.
 *
...
public class CodyDeps {
    ...
    private CodyDeps(Builder builder) {
    ...
    public static class Builder {
        ...
        public CodyDeps build() {
            return new CodyDeps(this);
        }
    }
}
