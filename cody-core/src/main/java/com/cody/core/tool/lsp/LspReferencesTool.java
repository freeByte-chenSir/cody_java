 ...
 *
 */
public class LspReferencesTool implements CodyTool {

    @Override public String getName() { return "lsp_references"; }

    @Override public String getDescription() {
        return "Find all references to a symbol at the given file position via LSP.";
    }
    ...
    public String execute(ToolContext ctx, Map<String, Object> arguments) {
        ...
        try {
            Object result = lspClient.getClass()
                    .getMethod("getReferences", String.class, int.class, int.class)
            ...
            return "[LSP_NOT_AVAILABLE] Cannot get references for '" + filePath + "': "
                    + e.getMessage();
        }
    }
}
