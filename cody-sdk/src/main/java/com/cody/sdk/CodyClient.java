...
import com.cody.sdk.events.EventManager;
import com.cody.sdk.types.StreamChunk;
...
public class CodyClient {
    ...
    CodyClient(Config config, Path workdir, SdkConfig sdkConfig) {
        this.config = config;
