 ...
 *   JodyApiError (base) → various subtypes
 *
 * Other exceptions:
 *   CircuitBreakerError, InteractionTimeoutError
 */
public class JodyErrors {
    ...
    public static class JodyApiError extends RuntimeException {
        private final ErrorCode code;

        public JodyApiError(ErrorCode code, String message) {
            super(message);
            this.code = code;
        }
    ...
    public static class AuthFailedError extends JodyApiError {
        public AuthFailedError(String message) {
            super(ErrorCode.AUTH_FAILED, message);
        }
    }

    public static class NotFoundError extends JodyApiError {
        public NotFoundError(ErrorCode code, String message) {
            super(code, message);
        }
    }

    public static class RateLimitError extends JodyApiError {
