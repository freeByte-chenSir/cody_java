...
import com.jody.core.error.JodyErrors.*;
...
public class ToolMiddleware {
     ...
     */
    public static void checkPermission(JodyDeps deps, String toolName, String argsSummary) {
     ...
     */
    public static String execute(JodyTool tool, ToolContext ctx,
                                  Map<String, Object> arguments, JodyDeps deps) {
